package resolveclaimsni.management.resolvestrategy.ui.composable.screen.settings
...
fun SettingsScreen(modifier: Modifier = Modifier) {
    ...
    SettingsScreenContent(
        modifier = modifier,
        onCustomerSupport = {
            context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://resolveclaims.study")))
        },
    )
}
...
fun SettingsScreenContent(
    ...
    Column(
        ...
        Card(Modifier.fillMaxWidth()) {
            SettingRow(Icons.Outlined.Business, "Company", "RESOLVE CLAIMS N.I. LTD")
