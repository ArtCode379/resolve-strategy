package resolve.projectdelivery.resolvestrategy.ui.composable.screen.bookings
...
import resolve.projectdelivery.resolvestrategy.ui.state.BookingUiState
import resolve.projectdelivery.resolvestrategy.ui.state.DataUiState
import resolve.projectdelivery.resolvestrategy.ui.theme.Success
...
fun BookingsScreen(
    ...
    canceledBookingNumber?.let { number ->
        AlertDialog(
            ...
            text = {
                Text("This consultation will be removed from your schedule.")
            },
            confirmButton = {
                TextButton(
                    onClick = {
            ...
            dismissButton = {
                TextButton(onClick = { canceledBookingNumber = null }) {
                    Text("Keep booking")
                }
            },
        )
...
private fun BookingsContent(
    ...
    TGRGKContentWrapper(
        ...
        dataEmpty = {
            TGRGKEmptyView(
                primaryText = stringResource(R.string.tgrgk_bookings_state_empty_primary_text),
