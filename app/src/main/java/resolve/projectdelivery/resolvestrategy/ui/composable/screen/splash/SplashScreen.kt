package resolve.projectdelivery.resolvestrategy.ui.composable.screen.splash
...
fun SplashScreen(
    ...
    viewModel: TGRGKSplashVM = koinViewModel(),
...
fun SplashScreenContent(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.tgrgk_app_name),
